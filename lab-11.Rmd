...
On average males tend to score .142 more on average 
...
```
R^2 = 0.0165 -- 1.65% of variability in score is explained by gender
R^2 = 0.035 -- 3.5% of variability in score explained by beauty 

Gender predicts less variability in score than beauty 
